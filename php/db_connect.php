...
$servername = "sql112.infinityfree.com"; // Asegúrate de que estos datos sean correctos
$username = "if0_39455541";             // Tu usuario de la base de datos
$password = "YdpPyCgwuJTWE";   // La contraseña de tu cuenta de hosting
